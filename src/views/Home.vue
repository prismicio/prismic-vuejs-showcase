  ...
  <div v-if="home">
    ...
    <section class="homepage-banner">
      ...
      <div class="homepage-banner-box-wrapper">
        ...
        <prismic-rich-text :field="home.data.banner_text" />
        </div>
      </div>
    </section>
    ...
    <div v-if="home.data.body" class="homepage-slices-wrapper">
      <div v-for="(slice, index) in home.data.body" :key="index">
        <div v-if="slice.slice_type === 'cta_banner'"
...
import ProductsGrid from './slices/ProductsGrid.vue';
import CtaBanner from './slices/CtaBanner.vue';
import NumerotedItems from './slices/NumerotedItems.vue';
import Separator from './slices/Separator.vue';
...
export default {
  ...
  async created() {
    const home = await this.$prismic.client.getSingle('homepage', { graphQuery });
    this.home = home;
  },
};
</script>
